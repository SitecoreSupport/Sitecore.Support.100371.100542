...
using System.Web.Http.ModelBinding;
    ...
    public class AnalyticsDataSupportController : AnalyticsDataController
    {
        ...
        public AnalyticsDataSupportController() : this(ApiContainer.Repositories.GetReportingService(), ApiContainer.GetLogger(), ApiContainer.GetReportResponseEncoder())
        {
        }

        public AnalyticsDataSupportController(IReportingService reportingService, ILogger logger, IEncoder<ReportResponse> encoder) : base(reportingService, logger, encoder)
        {
        ...
        private void LogMessages(ReportResponse reportResults)
        {
            if (reportResults.Messages != null)
            {
                ...
                builder.AppendLine("Request: {base.get_Request().RequestUri} returned messages.");
        ...
        internal class ContextSiteSwicherFilterAttribute : ActionFilterAttribute
        {
            ...
            public override void OnActionExecuting(HttpActionContext filterContext)
            {
                ...
                Switcher<SiteContext, SiteContextSwitcher>.Enter(Factory.GetSite(this.SiteName));
            }
        ...
        internal class RequirexDbFilterAttribute : ActionFilterAttribute
        {
            ...
            public RequirexDbFilterAttribute() : this(new AnalyticsDataSupportController.XDbSettings(), Logger.Instance)
            {
            }
